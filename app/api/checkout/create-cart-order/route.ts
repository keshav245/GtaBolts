...
export async function POST() {
  try {
    ...
    // credentials) produced a non-JSON response, which is exactly what
    // caused "Unexpected end of JSON input" on the client.
    console.error('create-cart-order failed:', err);
